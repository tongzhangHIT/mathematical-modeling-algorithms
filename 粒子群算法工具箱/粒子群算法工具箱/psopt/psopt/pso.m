...
if ~isempty(nonlcon) && ~strcmpi(options.ConstrBoundary,'soft')
    msg = 'Non-linear constraints only have ''soft'' boundaries' ;
...
if ~isempty(LB) || ~isempty(UB)
    ...
    options.LinearConstr.lb = LB ;
    options.LinearConstr.ub = UB ;
...
if ~isempty(Aeq) || ~isempty(Aineq) || ~isempty(nonlcon)
    ...
    options.LinearConstr.Aineq = Aineq ;
    options.LinearConstr.bineq = bineq ;
    options.LinearConstr.Aeq = Aeq ;
    options.LinearConstr.beq = beq ;
