% 画出配送中心选址图
% 画出配送中心
cargox=bestchrom([1,3,5,7,9]);
cargoy=bestchrom([2,4,6,8,10]);

ge_plot(cargox,cargoy,'rs','LineWidth',2,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','b',...
    'MarkerSize',10)
hold on
...
% 连接图
carlocationx=bestchrom([1,3,5,7,9]);
carlocationy=bestchrom([2,4,6,8,10]);
for i=9:128
    ...
    switch k
        ...
        case 6;plot(x,y,'k');hold on
        case 7;plot(x,y,'k');hold on
        case 8;plot(x,y,'k');hold on
        case 9;plot(x,y,'k');hold on
    end  
end